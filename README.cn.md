...
[![x-cmd/install — zoxide Code Quality Monitoring Repo Card](https://x-cmd.com/repo-card/zoxide.svg?lang=zh)](https://x-cmd.com/install/zoxide)
...
合计: **3,868** 行代码（覆盖前 5 种语言、共 **29** 个文件）。
...
- **上游仓库**: <https://github.com/ajeetdsouza/zoxide>
- **官网**: <https://crates.io/crates/zoxide>
- **许可证**: MIT
...
- **Star**: 39,666 · **Fork**: 908 · **开放 issue**: 752 · **贡献者**: 106

## 累计统计

- **发布数**: 38 · **已合并 PR**: 270 · **开放 PR**: 48 · **已关闭 issue**: 653 · **开放 issue**: 99 · **提交数**: 636

## 最近活动

| 时间窗口 | 起始 | 发布 | 已合并 PR | 开放 PR | 已关闭 issue | 开放 issue | 提交 |
|---|---|---:|---:|---:|---:|---:|---:|
| 30d | 2026-08-25 | 0 | 5 | 8 | 1 | 2 | 5 |
| last60d | 2026-07-26 | 0 | 11 | 16 | 2 | 2 | 13 |
| 90d | 2026-06-26 | 1 | 13 | 22 | 9 | 4 | 34 |
| last180d | 2026-03-28 | 1 | 19 | 27 | 19 | 7 | 40 |
| 360d | 2025-09-29 | 2 | 38 | 36 | 44 | 20 | 71 |
| last720d | 2024-10-04 | 4 | 71 | 44 | 150 | 43 | 128 |
...
zoxide 的安装元数据由 [x-cmd/install](https://github.com/x-cmd/install) 索引维护——这是一份由 x-cmd 在安装时读取的精选 YAML 包列表。如果 `zoxide` 缺失、过期，或安装行为有问题，欢迎在该 repo 提 issue 或 PR：

- **提交 issue**: <https://github.com/x-cmd/install/issues/new>
- **编辑包条目**: <https://github.com/x-cmd/install/edit/main/zoxide.yml>（或索引实际使用的路径）

本页面的数据（card / loc / scorecard / release）由 [x-cmd-install-action](https://github.com/x-cmd-install/x-cmd-install-action) 自动采集，每日重新生成。**安装行为**（版本选择、平台差异、依赖处理）的改进应提交到上游索引。

_数据快照: `data/card/260924.yml` · 2026-09-24T04:51:50Z._
